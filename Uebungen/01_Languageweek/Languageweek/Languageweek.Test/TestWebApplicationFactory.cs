// =================================================================================================
// Helperklasse für Integration Tests in ASP.NET Core.
// Michael Schletz, 2026-03-12
// =================================================================================================
...
public class TestWebApplicationFactory<Tcontext>(string environment = "Testing") : WebApplicationFactory<Program> where Tcontext : DbContext
{
    ...
    /// <summary>
    /// Ersetzt den DbContext des Webservers durch die angegebene Konfiguration.
    /// </summary>
    ...
    /// <summary>
    /// Ersetzt ein Service des Webservers.
    /// </summary>
    ...
    /// <summary>
    /// Erlaubt das Abfragen der Datenbank über den im Serviceprovider registrierten DbContext.
    /// </summary>
